...
const Sobre = props => (
    ...
    <div className="Cards">
        ...
        <p>O aquecimento global continua a aumentar, uma das razões são os grandes incêndios sem controle
...
por incêndios. <br/>
    O aplicativo contará com diversas funcionalidades, entre elas: Um mapa com indicadores de focos de incêndios pelo 
        mundo, conexão com nossos alarmes de incêndio e opções para denunciar focos de fogo e ligar para as autoridades locais.
        <br/>
